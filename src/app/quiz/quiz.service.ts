...
export class QuizService implements OnInit {
  ...
  getArr() {
    for (let song of this.songsArr2) {
      console.log('getARR: '+ song)
    }
  }


  getSong() {
    // console.log(`${this.URL}/audio/${this.quizRound}-${this.correctIndex + 1}.mp3`)
    return `${this.URL}/audio/${this.quizRound}-${this.correctIndex + 1}.mp3`
  }

  getGenreSongs() {
    // console.log(this.quizData[this.quizRound - 1].data)
      ...
      "data":
        [
          {"id":"4-1",
            ...
            "audio":"audio/4-1.mp3",
            "description":"Two Steps from Hell is an American production music company based in Los Angeles, California, founded by Thomas Bergersen and Nick Phoenix in 2006. The company focuses predominantly on movie and trailer music, and has supplied tracks to films such as Harry Potter, Pirates of the Caribbean, and X-Men."
          },
          {"id":"4-2","name":"Hans Zimmer",
            "songTitle":"Time",
          ...
          {"id":"4-3",
            ...
            "audio":"audio/4-3.mp3",
            "description":"Audiomachine is an American production music company based in Beverly Hills, California. The company was founded by Paul Dinletir and Carol Sovinski in August 2005, producing music composed by Paul Dinletir and Kevin Rix."
          },
          {"id":"4-4",
            ...
            "audio":"audio/4-4.mp3",
            "description":"ReallySlowMotion is a music and sound production team of experienced professionals whose main focus is Film, Game, TV. We write, record, produce and mix under your request to provide you with any soundtrack or sound design your project may need."
          }
        ]
      }
  ]
